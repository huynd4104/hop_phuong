...
void _userSerialize(
  ...
  writer.writeBool(offsets[0], object.isOwner);
...
User _userDeserialize(
  ...
  final object = User(
    id: id,
    isOwner: reader.readBoolOrNull(offsets[0]) ?? false,
...
extension UserQueryWhereSort on QueryBuilder<User, User, QWhere> {
  ...
  QueryBuilder<User, User, QAfterWhere> anyIsOwner() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'isOwner'),
      );
    });
  }
}
...
extension UserQueryWhere on QueryBuilder<User, User, QWhereClause> {
  ...
  QueryBuilder<User, User, QAfterWhereClause> isOwnerEqualTo(bool isOwner) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> isOwnerNotEqualTo(bool isOwner) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> isOwnerEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isOwner',
        value: value,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  QueryBuilder<User, User, QAfterSortBy> sortByIsOwner() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isOwner', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByIsOwnerDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByIsOwner() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isOwner', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByIsOwnerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isOwner', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  QueryBuilder<User, User, QDistinct> distinctByIsOwner() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, bool, QQueryOperations> isOwnerProperty() {
    return QueryBuilder.apply(this, (query) {
