...
class EmptyState extends StatelessWidget {
  const EmptyState({required this.title, required this.subtitle, this.icon});
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(icon ?? Icons.inbox_outlined, size: 36, color: cs.primary),
              ),
              ...
              Text(subtitle, textAlign: TextAlign.center, style: TextStyle(color: cs.onSurfaceVariant, height: 1.5)),
            ],
          ),
        ),
      ),
